...
SUBOB_LENGTH=8.0
HEADER_SIZE=0
HEADER_FILENAME="min_v2_header_128T.txt"
SUBFILE_NAME="test_subfile_4800_5312_1456_n0_01_128T_v2.sub"
...
echo
./make_test_subfile_v2_delay_tables -T ${NUM_TILES} -H ${HEADER_FILENAME} -s subfile_source_files.txt -D subfile_source_delays.txt -o ${SUBFILE_NAME}
echo
